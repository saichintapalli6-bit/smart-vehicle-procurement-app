            ...
            >
                ...
                <Animated.View style={[
                    ...
                    <View style={styles.heroHeader}>
                        ...
                        <TouchableOpacity style={styles.logoutBtnSolid} onPress={() => navigation.navigate('Home')}>
...
const styles = StyleSheet.create({
    ...
    scrollContentContainer: { paddingHorizontal: 40 },
    mainContainer: { 
        minHeight: '100%',
        paddingBottom: 100,
        paddingTop: 20
    ...
    headerLeft: { flexDirection: 'row', alignItems: 'center', gap: 28 },
    welcomeTitle: { color: '#f0b90b', fontSize: 18, fontWeight: '800', marginBottom: 4, letterSpacing: 0.5 },
    welcomeName: { color: '#ffffff', fontSize: 36, fontWeight: '900', letterSpacing: -1 },
    welcomeSub: { color: '#94a3b8', fontSize: 16, fontWeight: '600', marginTop: 4 },
    sellerIcon: {
        width: 80, height: 80,
        borderRadius: 24,
    ...
    tabLabel: { color: '#94A3B8', fontSize: 18, fontWeight: '700' },
    ...
    formPanel: {
        width: '100%',
        maxWidth: 800,
        backgroundColor: '#0f172a', // Solid Blue-Grey for Form
        borderRadius: 32,
        padding: SCREEN_WIDTH < 600 ? 24 : 56,
        borderWidth: 2,
        borderColor: '#1e3a8a',
        shadowColor: '#1e40af',
    ...
    formBadgeText: { color: '#ffffff', fontSize: 13, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.5 },
    formMainTitle: { color: '#ffffff', fontSize: 32, fontWeight: '900', textAlign: 'center' },
    formSubTitle: { color: '#94a3b8', fontSize: 16, textAlign: 'center', marginTop: 12 },

    fieldLabel: { color: '#f8fafc', fontSize: 16, fontWeight: '800', marginBottom: 12, letterSpacing: 0.5 },
    ...
    currencyIcon: { color: '#f0b90b', fontSize: 24, fontWeight: '900' },
    ...
    directUploadText: { color: '#ffffff', fontSize: 15, fontWeight: '700' },
    ...
    historyHeroHeader: {
        ...
        alignItems: 'center',
        padding: 40,
        backgroundColor: '#312e81', // Solid Indigo for History
        borderRadius: 32,
        marginBottom: 40,
        borderWidth: 2,
        borderColor: '#4338ca',
    ...
    historyLeft: { flexDirection: 'row', alignItems: 'center', gap: 20 },
    historyTitle: { color: '#ffffff', fontSize: 32, fontWeight: '900' },
    historySubtitle: { color: '#94a3b8', fontSize: 18 },
    refreshBtnSolid: {
    ...
    vehicleCardHeader: { flexDirection: 'row', alignItems: 'center', gap: 20 },
    vehicleNumberBadge: {
        paddingHorizontal: 16, paddingVertical: 12,
        borderRadius: 24,
        backgroundColor: 'rgba(240, 185, 11, 0.15)',
    },
    vehicleNumberText: { color: '#f0b90b', fontSize: 16, fontWeight: '900' },
    vehicleNumber: { color: '#ffffff', fontSize: 30, fontWeight: '900' },
    vehiclePrice: { color: '#10B981', fontSize: 36, fontWeight: '900' },
    statusBadgeLarge: {
        paddingHorizontal: 24, paddingVertical: 12,
        borderRadius: 24,
    ...
    txnBtnText: { color: '#60A5FA', fontSize: 16, fontWeight: '700' },
