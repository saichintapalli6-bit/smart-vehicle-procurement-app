        ...
        <View style={styles.root}>
            ...
            <View style={styles.navbar}>
                ...
                <View style={styles.navRight}>
                    ...
                    <TouchableOpacity style={styles.logoutBtn} onPress={() => navigation.navigate('DrawerRoot')}>
                            ...
                            {loading ? (
                                ...
                                filtered.map((u, idx) => (
                                    <View key={u.id} style={[styles.tableRow, idx % 2 === 1 && styles.tableRowAlt]}>
                                        ...
                                        <View style={[styles.cell, { width: 240, flexDirection: 'row', gap: 8, justifyContent: 'center' }]}>
                                            <TouchableOpacity
